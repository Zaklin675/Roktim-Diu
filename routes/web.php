...
//user
Route::get('/user-login','UserLoginController@showUserLoginForm')->name('user.login.form');
Route::post('/user-login-action','UserLoginController@userLogin')->name('user.login');
Route::get('/user-logout','UserLoginController@UserLogout')->name('normal-user.logout');
Route::get('/user-register','UserLoginController@showUserRegisterForm')->name('user.register.form');
Route::post('/user-register-action','UserLoginController@userRegister')->name('user.register');
Route::get('/user-details','SiteController@userDetails')->name('user.details');

//Change User Blood Request  Status  && Delete
Route::get('/user-change-status','SiteController@userChangeStatus')->name('user.change.status');
Route::get('/user-blood-request-delete/{id}','SiteController@userBloodRequestDelete')->name('user.request.blood.delete');
...
Route::namespace('Donor')->prefix('donor')->name('donor.')->group(function () {
    ...
    Route::middleware(['donor'])->group(function () {
        ...
        Route::get('donor-request', 'DonorController@donorRequest')->name('donor.request');

        Route::get('/donor-change-status','DonorController@donorChangeStatus')->name('donor.change.status');
...
Route::get('/blood/requests', 'SiteController@bloodRequest')->name('blood_request');
Route::get('/blood/request/add','SiteController@addBloodRequest')->name('add_blood_request');
Route::post('/blood/request/store', 'SiteController@bloodRequestStore')->name('blood.request.store');
Route::get('/complete/request/{id}','SiteController@completeRequest')->name('complete_request');