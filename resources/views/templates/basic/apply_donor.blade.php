        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="POST" action="{{route('apply.donor.store')}}" class="contact-form bg-white p-sm-5 p-3 rounded-3 position-relative" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <h5 class="mb-3">@lang('Login Credentials')</h5>
                        <div class="form-group col-lg-6">
                            <label for="username">@lang('username') <sup class="text--danger">*</sup></label>
                            <input type="text" name="username" id="username" value="{{old('username')}}" placeholder="@lang('Enter Username')" class="form--control" maxlength="60" required="">
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="password">@lang('password') <sup class="text--danger">*</sup></label>
                            <input type="password" name="password" id="password" value="{{old('password')}}" placeholder="@lang('Enter Password')" class="form--control" maxlength="40" required="">
                        </div>
                    </div>
